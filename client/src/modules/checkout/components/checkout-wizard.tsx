...
import { placeOrder } from "@/modules/checkout/services/checkout.service";
...
export function CheckoutWizard() {
  ...
  function onPaymentMock(method: "card" | "paypal") {
    const summary =
      method === "card" ? "Visa •••• 4242" : "PayPal account";
      ...
      <aside className="bg-muted/40 border-border h-fit space-y-4 rounded-xl border p-6 lg:sticky lg:top-28">
        ...
        <div className="space-y-2">
          ...
          <div className="flex gap-2">
            ...
            />
            <Button type="button" variant="secondary" onClick={() => void validateCoupon()}>
              Apply
            </Button>
          </div>
          {couponValid && (
